...
- July 19, 2025. Improved layout consistency for result cards: changed from 3 to 4 generated results for better visual symmetry, updated responsive grid to display 1 column on mobile, 2 columns (2x2) on small/medium/large screens, and 4 columns (1x4) on extra-large screens, added max-width container to prevent cards from getting too wide on ultra-wide displays
