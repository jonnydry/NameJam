...
- July 13, 2025. Simplified AI prompts and enhanced repetitive word filtering: per user feedback, dramatically simplified prompts to just "Imagine a random name for a [band/song]" format, upgraded filter to block ANY use of overused words (echoes, shadows, whispers, darkness, midnight, sorrow, twilight, ethereal, enigma, abyss), system now rejects and retries when detecting these words at any position, forcing AI to generate truly creative alternatives like "Sighs in Blue" and "Euphoric Rage Symphony"
