...
- July 25, 2025. Enhanced XAI API prompt system: implemented user-requested JSON-based prompt structure for band name generation with explicit mood/genre integration and exact word count enforcement, updated AI service to parse JSON responses correctly, achieved perfect integration with new prompt format generating contextually appropriate names like "Obsidian Crypt Whisper" for dark rock themes
