  ...
  private getStaticMoodFilteredWords(mood?: string): WordSource {
    ...
    const moodThemes = {
      dark: {
        ...
        musicalTerms: ['Requiem', 'Dirge', 'Lament', 'Minor', 'Diminuendo', 'Funeral March', 'Death Metal', 'Black Metal', 'Doom Metal', 'Gothic', 'Darkwave', 'Industrial', 'Noise', 'Ambient', 'Drone', 'Sludge', 'Stoner', 'Post-Metal', 'Post-Rock', 'Post-Punk', 'Coldwave', 'Minimal Wave', 'Synthwave', 'Darksynth', 'Horror Synth', 'Witch House', 'Dark Ambient', 'Dungeon Synth', 'Martial Industrial', 'Power Electronics', 'Harsh Noise', 'Death Industrial', 'Dark Folk', 'Neofolk', 'Apocalyptic Folk', 'Ritual Ambient', 'Dark Jazz', 'Funeral Doom', 'Atmospheric Black Metal', 'Depressive Black Metal', 'Suicidal Black Metal', 'Raw Black Metal', 'Symphonic Black Metal', 'Melodic Black Metal', 'Progressive Black Metal', 'Blackgaze', 'Post-Black Metal', 'Blackened Death Metal', 'Blackened Doom', 'Blackened Sludge', 'Blackened Crust', 'Blackened Thrash', 'Blackened Speed Metal', 'Blackened Heavy Metal', 'Blackened Power Metal', 'Blackened Progressive Metal', 'Blackened Post-Metal', 'Blackened Post-Rock', 'Blackened Post-Hardcore', 'Blackened Metalcore', 'Blackened Deathcore', 'Blackened Grindcore', 'Blackened Powerviolence', 'Blackened Fastcore', 'Blackened Hardcore Punk', 'Blackened Crust Punk', 'Blackened D-Beat', 'Blackened Crossover Thrash', 'Blackened Municipal Waste', 'Blackened Thrashcore', 'Blackened Skatepunk', 'Blackened Street Punk', 'Blackened Oi!', 'Blackened RAC', 'Blackened NSBM', 'Blackened Unblack Metal', 'Blackened Christian Metal', 'Blackened Viking Metal', 'Blackened Pagan Metal', 'Blackened Folk Metal', 'Blackened Celtic Metal', 'Blackened Medieval Metal', 'Blackened Renaissance Metal', 'Blackened Baroque Metal', 'Blackened Classical Metal', 'Blackened Neoclassical Metal', 'Blackened Symphonic Metal', 'Blackened Orchestral Metal', 'Blackened Chamber Metal', 'Blackened String Quartet Metal', 'Blackened Piano Metal', 'Blackened Organ Metal', 'Blackened Harpsichord Metal', 'Blackened Accordion Metal', 'Blackened Bagpipe Metal', 'Blackened Didgeridoo Metal', 'Blackened Kazoo Metal']
      },
      bright: {
