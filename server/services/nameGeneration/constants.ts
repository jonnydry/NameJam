...
export const AI_RETRY_MULTIPLIER = 10; // Generate up to 10x more candidates if needed
export const DATAMUSE_RETRY_MULTIPLIER = 10; // Generate up to 10x more candidates if needed
export const BATCH_GENERATION_MULTIPLIER = 3; // Generate 3x in parallel for each batch
...
export const VERY_RECENT_WORD_TIMEOUT = 30 * 1000; // 30 seconds
export const RECENT_WORD_TIMEOUT = 2 * 60 * 1000; // 2 minutes
export const WORD_MEMORY_TIMEOUT = 10 * 60 * 1000; // 10 minutes
